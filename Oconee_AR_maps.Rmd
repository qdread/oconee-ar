...
The wastewater treatment greatly reduces the copy numbers, both absolute and relative, of the AR genes. We have evidence for this effect in all genes. Interestingly, the strength of the effect differs somewhat by season.

```{r, echo = FALSE}
ww_arg_abs_emm_type <- emmeans(ww_arg_abs_fit, ~ type, type = 'response')
...
ww_arg_rlt_emm_type <- emmeans(ww_arg_rlt_fit, ~ type, type = 'response')
...
# FIXME If any contrasts need to be done, include them here.

# FIXME Include the plots here.
```
