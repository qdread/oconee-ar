...
```{r, echo = FALSE}
plot_marginal_effect(variable = 'conductivity', backtransform_log = TRUE, breaks_x = c(30, 100, 300))
```
...
```{r, echo = FALSE}
plot_marginal_effect(variable = 'Ecoli_counts', backtransform_log = TRUE, breaks_x = c(0, 30, 100, 300, 3000))
```
