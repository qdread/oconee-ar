...
```{r, echo = FALSE}
w_ar_pres_abs <- melt(w_env_ar, id.vars = w_id_cols, measure.vars = c('AR_Ecoli_presence', 'Salmonella_presence',                   'Enterococcus_presence', 'ESBL', 'CRE'), variable.name = 'taxon')
...
ESBL_mod <- glmer(ESBL ~ temperature + pH + conductivity + turbidity + Ecoli_counts + (1|season) + (1|site), data = w_env_ar_model_data)
CRE_mod <- glmer(CRE ~ temperature + pH + conductivity + turbidity + Ecoli_counts + (1|season) + (1|site), data = w_env_ar_model_data)
Enter_mod <- glmer(Enterococcus_presence ~ temperature + pH + conductivity + turbidity + Ecoli_counts + (1|season) + (1|site), data = w_env_ar_model_data)
Salm_mod <- glmer(Salmonella_presence ~ temperature + pH + conductivity + turbidity + Ecoli_counts + (1|season) + (1|site), data = w_env_ar_model_data)
AREc_mod <- glmer(AR_Ecoli_presence ~ temperature + pH + conductivity + turbidity + Ecoli_counts + (1|season) + (1|site), data = w_env_ar_model_data)
```
